  ...
  return (
    <div className="profile-menu" ref={menuRef}>
      ...
      {open && <div className="profile-popover">
        ...
        {config.auth_enabled && <button className="profile-signout" type="button" onPointerDown={beginSignOut}><LogOut size={16} /><span><strong>Sign out</strong><small>Keep this device data private</small></span></button>}
      </div>}
    </div>
  )
}